...
```
helm upgrade -i granite-guardian redhat-ai-services/vllm-kserve --version 0.5.8 \
...
```
helm upgrade -i granite-8b redhat-ai-services/vllm-kserve --version 0.5.8 \
...
====
```
helm upgrade -i vllm-multi-node-llama redhat-ai-services/vllm-kserve --version 0.5.8 \
