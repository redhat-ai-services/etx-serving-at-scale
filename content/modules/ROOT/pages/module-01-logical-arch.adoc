...
== What is it
A solution providing AI models as the *Service* to a larger audience

* IT serves common models centrally or remotely
** Generative AI focus but applicable to any model
...
Self-Service is good for small teams with plentiful resources

Throwing GPUs at the problem is wateful
...
Developed by the BU CAI team using RH Technology
...
Constraints:
3Scale is going away
Customer already have their own API gateways
