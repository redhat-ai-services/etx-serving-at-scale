...
image::../assets/images/gpu0.png[The tensor parallel approach, 600]
...
image::../assets/images/gpu2.png[The two primary techniques that enable tensor parallelism, 600]
...
image::../assets/images/gpu3.png[Tensor parallelism distribution across GPUs, 600]
