...
+
image::../assets/images/03-datascience-project.png[Composer AI Apps Project]

. Select the `Models` tab and click `Select single-model`

+
image::../assets/images/03-single-model-serving.png[Single Model]

. Select `Deploy model`

+
image::../assets/images/03-deploy-model.png[Deploy Models]
...
+
image::../assets/images/03-deploy-model-configs.png[Model Options]
...
+
image::../assets/images/03-deploy-model-data-connection.png[URI Connection]
...
+
image::../assets/images/03-deploy-model-route.png[Model endpoint]
